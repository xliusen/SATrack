...
# print("local_rank from env:", local_rank)
import sys
import argparse
import importlib
import cv2 as cv
...
'''
cd /home/dell/WorkSpace/Tracking_by_NL/All-in-One/lib/train/
conda activate python38     
nohup python run_training_all_in_one.py > training_all_in_one.log 2>&1 &
'''
...
def main():
    ...
    # parser.add_argument('--config', type=str, default='vit_tiny_256_mae_ce_32x4_ep300', help="Name of the config file.")
    ...
    # 兼容 torchrun 或 launch 自动传入的 local-rank
