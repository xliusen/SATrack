...
# nohup python run_training.py > train_ostrack.log 2>&1 &
...
def main():
    ...
    # parser.add_argument('--config', type=str, default='vitb_384_mae_ce_32x4_ep300', help="Name of the config file.")
    parser.add_argument('--cudnn_benchmark', type=bool, default=True,
                        help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local_rank', default=-1, type=int, help='default=-1, node rank for distributed training')
    parser.add_argument('--save_dir', type=str, default='/home/dell/WorkSpace/Tracking_by_NL/All-in-One/output',
