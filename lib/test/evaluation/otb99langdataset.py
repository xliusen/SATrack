...
class OTB99LANGDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        anno_path = '/data/data6T/dataset/OTB_sentences/OTB_videos/{}/groundtruth_rect.txt'.format(sequence_name)
        ...
        frames_path = '/data/data6T/dataset/OTB_sentences/OTB_videos/{}/img'.format(sequence_name)
        ...
        # language = None
        try:
            language_file = os.path.join('/data/data6T/dataset/OTB_sentences/OTB_query_test', f"{sequence_name}.txt")
            # print(language_file)
    ...
    def _get_sequence_list(self):
        ...
        # 筛选出txt文件的名字并移除后缀
        sequence_list = [os.path.splitext(file)[0] for file in all_files if file.endswith('.txt')]
